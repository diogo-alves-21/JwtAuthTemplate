...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response,
        ...
        log.debug("Incoming request {} {} | Authorization header={}", request.getMethod(), request.getRequestURI(),
                authHeader);
        ...
        try {
            ...
            log.error("Failed to authenticate JWT for request {} {}: {}", request.getMethod(), request.getRequestURI(),
